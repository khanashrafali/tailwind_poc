  ...
  return (
    <>
      <div className="flex h-screen">
        {/* First Half */}
        <div className="flex flex-col basis-1/2 flex-grow-0 items-center justify-center w-1/2 bg-cover bg-center bg-no-repeat relative">
          <div
        ...
        {/* Second Half */}
        <div className="flex flex-col basis-1/2 flex-grow-0 items-start justify-center w-1/2 bg-white px-[70px]">
          ...
          {/* Login Button */}
          <button className="inline-flex items-center justify-center relative box-border select-none align-middle bg-[#ff6c00] text-[0.875rem] leading-[1.75] tracking-[0.02857em] uppercase rounded-[32px] px-[8px] py-[6px] min-w-[106px]">
            Login
          </button>

          {/* Forgot Password Link */}
          <p className="w-[40%] leading-[1.5] tracking-[0.00938em] text-[#3cbfae] mt-[30px] text-sm border-solid border-b-[3px] border-[#3cbfae]">
            Forgot password?
          </p>
        </div>
      </div>
